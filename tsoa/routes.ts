...
const models: TsoaRoute.Models = {
    ...
    "askProps": {
        "dataType": "refAlias",
        "type": {"dataType":"nestedObjectLiteral","nestedProperties":{"systemMessage":{"dataType":"string"},"userMessage":{"dataType":"string","required":true},"chatId":{"dataType":"double"}},"validators":{}},
    },
    // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
};
...
export function RegisterRoutes(app: Router) {
    ...
    // ###########################################################################################################
        ...
        app.post('/openai/ask',
            ...
            const args: Record<string, TsoaRoute.ParameterSchema> = {
                    body: {"in":"body","name":"body","required":true,"ref":"askProps"},
            };
        ...
        // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
        app.get('/message/:chatId/:messageId',
            ...(fetchMiddlewares<RequestHandler>(MessageController)),
        ...
        app.get('/chat/:userId',
            ...
            ...(fetchMiddlewares<RequestHandler>(ChatController.prototype.getChats)),

            async function ChatController_getChats(request: ExRequest, response: ExResponse, next: any) {
            const args: Record<string, TsoaRoute.ParameterSchema> = {
                    userId: {"in":"path","name":"userId","required":true,"dataType":"double"},
            };
